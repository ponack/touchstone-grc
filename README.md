...
<p align="center">
  <a href="https://github.com/ponack/touchstone-grc/releases/tag/v0.3.0"><img src="https://img.shields.io/badge/release-v0.3.0-C49020?style=flat-square" alt="v0.3.0" /></a>
...
> **Status:** v0.3.0 shipped 2026-05-28 — Phase 3 complete. **AWS and Azure now evaluate in parallel** with one OPA policy per control. 9 of 11 SOC 2 2017 controls in the shipped pack run real, multi-cloud evaluations. The two remaining (CC6.2 user-access provisioning, CC7.4 incident response) need procedural evidence and ship with the next-phase GitHub/Jira connector. GCP support mirrors this shape in a follow-up phase.
...
| CC6.2 — New user access provisioning | ⏸ procedural | (needs GitHub/Jira) | (needs GitHub/Jira) |
...
| CC7.4 — Incident response | ⏸ procedural | (needs GitHub/Jira) | (needs GitHub/Jira) |
...
```text
ghcr.io/ponack/touchstone-api:0.3.0
ghcr.io/ponack/touchstone-ui:0.3.0
```
...
- **Phase 4** — Procedural connectors: GitHub + Jira/Linear → unlocks CC6.2 (provisioning workflows) + CC7.4 (incident response), bringing SOC 2 coverage to 11/11 real.
