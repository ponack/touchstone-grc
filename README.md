...
<p align="center">
  <a href="https://github.com/ponack/touchstone-grc/releases/tag/v0.7.0"><img src="https://img.shields.io/badge/release-v0.7.0-C49020?style=flat-square" alt="v0.7.0" /></a>
...
> **Status:** v0.7.0 shipped 2026-05-31 — **PCI DSS v4.0 pack ships alongside SOC 2 and CIS AWS**, with 9 automatable rules across Reqs 1 (network) / 3 (encryption at rest) / 4 (transit) / 7 (least privilege) / 8 (identity + MFA) / 10 (audit logs) / 11 (vuln scanning + IDS). Every signal reuses evidence already collected for the other packs — the procedural majority of PCI's ~300 sub-controls remains auditor-reviewed against signed policies and process docs.
...
- Ships **SOC 2 2017**, **CIS AWS Foundations v1.5.0**, and **PCI DSS v4.0** control packs today; HIPAA / ISO 27001 on the roadmap.
...
```text
ghcr.io/ponack/touchstone-api:0.7.0
ghcr.io/ponack/touchstone-ui:0.7.0
```
...
- **Phase 6** — Framework breadth: CIS AWS Foundations v1.5 *(complete — v0.6.0, 51 rules)*, PCI DSS v4.0 *(complete — v0.7.0, 9 automatable rules)*; HIPAA / ISO 27001 packs follow.
